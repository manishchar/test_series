                ...
                <div class="panel panel-bd lobidrag">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="btn-group" id="">
                                    <h4>View College code</h4>
                                </div>
                            </div>
                            <div class="col-md-6 text-right">
                                <div class="btn-group">
                                   <a href="<?php echo base_url();?>admin/collagecode" class="btn btn-default"><span class="fa fa-long-arrow-left"></span></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="panel-body">
                        ...
                        <div class="inbox-mail-details p-20">
                            <div class="avatar-name">
                                <strong>Code: </strong>
                                <?php if(!empty($selectall)){ echo ucfirst($selectall->code);}else{ echo "-";} ?>
                            </div>
                        </div>
