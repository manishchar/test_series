...
?> 
                ...
                <div class="panel-body">
                    <form class="col-sm-9" method="post" action="<?php echo base_url(); ?>agent/loanrepayment/add_loan" enctype="multipart/form-data">
                    <?= msg();?>
      <div class="row">
       <div class="col-sm-6">
      ...
      <div class="row">
       ...
       <div class="form-group">
        <div class="form-group">
                ...
                <input type="text"   onchange="txtAmountChanged()" class="form-control"  name="amount" id="amount" placeholder="Enter amount"  value=""  >
                </div>
       </div></div>
       <div class="col-sm-6">
                <div class="form-group">
                ...
                <input type="text"  class="form-control"  name="penalty" id="penalty" placeholder="Enter penalty"  value=""  >
                </div>
      </div>
      </div>
