...
<div class="content-wrapper">
  ...
  <select class="form-control chosen-select" name="technology" id="technology">
                ...
                $remaindata=$this->admin->getRow("SELECT sum(amount) as totalamount,sum(penalty) as totalpenalty FROM loan_payment WHERE loan_id = '".$datalisti->loan_id."'"); 
                $date = strtotime($datalisti->currentdate);
...
$diff->format("%a");
                                    ...
                                    <tr data-row-id="<?php echo $datalisti->id;?>">
                                         <td><?php echo $datalisti->loan_id; ?></td>
                                         <td><?php echo $datalisti->loan_id; ?></td>
   ...
   echo date('d/m/y', $date); ?></td>
                                         <td><?php $date1 = strtotime($datalisti->currentdate);
   $date1 = strtotime("+".$datalisti->period." day", $date1);
   echo date('d/m/y', $date1); ?></td>
                                         <td><?php echo $datalisti->total_amount; ?></td>
                                          <td><?php if(!empty($remaindata)){ echo $remaindata->totalamount;}?></td> 
                                          <td><?php if(!empty($remaindata)){ $a = $datalisti->total_amount - $remaindata->totalamount;  echo $a;}?></td>
