      ...
      <div class="flex-center rgba-black-strong pb-5">
        <div class="container">
          ...
          <div class="col-lg-6 ">
              ...
              <form class="white rounded px-3 py-4" method="post" action="<?php echo base_url(); ?>home/add_student" enctype="multipart/form-data">
                   <?= msg();?>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label class="text-uppercase font-weight-700 font-13">Technology <span style="color:red;">*</span></label>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                     ...
                     <label>Date</label> <label  >&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspTime</label>
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="col-md-6">
                          <div class="form-group">
                            <label class="text-uppercase font-weight-700 font-13">degree <span style="color:red;">*</span></label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                              <label class="text-uppercase font-weight-700 font-13">branch <span style="color:red;">*</span></label>
                      ...
                      <input type="text"  class="form-control"  name="roll_no" placeholder="Enter   Enrollment No."  value="<?php if(!empty($selectall)){ echo $selectall->roll_no;}elseif($form_data){ echo $form_data['roll_no'];}?>"  required>
                        ...
                        <input type="text"  class="form-control" name="mobile" placeholder="Enter  Mobile Number" value="<?php if(!empty($selectall)){ echo $selectall->mobile;}elseif($form_data){ echo $form_data['mobile'];}?>"  required >
                                   ...
                                   <div class="col-md-6">
                    <div class="form-group">
                      <label class="text-uppercase font-weight-700 font-13">Internship *</label>
                      <br>
                      <!-- Material inline 1 -->
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        <label class="text-uppercase font-weight-700 font-13">Test Series *</label>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label class="text-uppercase font-weight-700 font-13">Fees Amount *</label>
                      <input type="text" class="form-control" placeholder="Enter Fees Amount">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      <label class="text-uppercase font-weight-700 font-13">Registration Amount *</label>
                      <input type="text" class="form-control" placeholder="Enter Registration Amount">
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
                      <label class="text-uppercase font-weight-700 font-13">Installment *</label>
                      <input type="text" class="form-control" placeholder="Enter Installment Amount">
                    </div>
                  </div>
