...
class Report extends CI_Controller {
    ...
    {
        $data['students']=$this->db->select('tab1.*,tab2.starttime,tab2.endtime,tab3.name as collageName,tab4.name as branchName')
        ->join('batch as tab2','tab2.id = tab1.batch_id')
        ->join('collagecode as tab3','tab3.id = tab1.college')
        ->join('branch as tab4','tab4.id = tab1.branch')
        ->get('student as tab1')->result_array();
        $data['template']='admin/report/index';
