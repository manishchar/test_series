...
class Image_moo  
{
    ...
    public function upload_slider_img_move($obj,$tmpimg, $image_name,$folder)
    {
        //$image_size = getimagesize($tmpimg);
       
            $obj->load($tmpimg)->save(BASEDIRPATD."/uploads/".$folder."/org/".$image_name,true)			
                 ->resize(1351,700)
                ->save(BASEDIRPATD."/uploads/".$folder."/web/".$image_name,true)
                ->resize(500,100)
                ->save(BASEDIRPATD."/uploads/".$folder."/popup/".$image_name,true)
                ->resize(250,100)
                ->save(BASEDIRPATD."/uploads/".$folder."/thumb/".$image_name,true)
                ->resize(50,50)
                ->save(BASEDIRPATD."/uploads/".$folder."/icon/".$image_name,true)
                ->clear();
        
        
        return "uploads/".$folder."/org/".$image_name;
    }
    
    public function upload_query_video_move($obj,$tmpimg, $image_name,$folder)
    {
        $obj->load($tmpimg)->save(BASEDIRPATD."/uploads/".$folder."/org/".$image_name,true)			
                        ->save(BASEDIRPATD."/uploads/".$folder."/web/".$image_name,true)
                        ->save(BASEDIRPATD."/uploads/".$folder."/popup/".$image_name,true)
    ...
    public function upload_query_img_move($obj,$tmpimg, $image_name,$folder)
    {
        $obj->load($tmpimg)->save(BASEDIRPATD."/uploads/".$folder."/org/".$image_name,true)			
                        ->resize(700,350) 
                        ->save(BASEDIRPATD."/uploads/".$folder."/web/".$image_name,true)
    ...
    public function upload_adver_img_move($obj,$tmpimg, $image_name,$folder)
    {
        $obj->load($tmpimg)			
            ->save(BASEDIRPATD."/uploads/".$folder."/org/".$image_name,true)
            ->resize(750,750)
            ->save(BASEDIRPATD."/uploads/".$folder."/web/".$image_name,true)
            ->resize(200,200)
            ->save(BASEDIRPATD."/uploads/".$folder."/popup/".$image_name,true)
    ...
    public function upload_img_move($obj,$tmpimg, $image_name,$folder)
    {
        $obj->load($tmpimg)			
            ->save(BASEDIRPATD."/uploads/".$folder."/org/".$image_name,true)
            ->resize(750,750)
    ...
    public function upload_brand_logo($obj,$tmpimg, $image_name,$folder)
    {
        $obj->load($tmpimg)			
            ->save(BASEDIRPATD."/uploads/".$folder."/org/".$image_name,true)
            ->resize(750,750)
