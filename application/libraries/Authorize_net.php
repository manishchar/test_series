...
class Authorize_net
{
    ...
    private $api_login_id = '7Z34waLtX';			// API Login ID
    private $api_transaction_key = '4Nq9k863pn8YN9XL';	// API Transaction Key
    private $api_url = ' https://test.authorize.net/gateway/transact.dll';				// Where we postin' to?
